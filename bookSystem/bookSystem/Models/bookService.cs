...
namespace bookSystem.Models
{
    ...
    public class bookService
    {
        ...
        /// <returns></returns>
        public void InsertBook(bookInsert bookInsertData)
        {
            ...
            using (SqlConnection conn = new SqlConnection(this.GetDBConnectionString()))
            {
                ...
                //cmd.ExecuteScalar();//執行查詢，並傳回查詢所傳回之結果集中第一個資料列的第一個資料行。 忽略其他資料行或資料列
                cmd.ExecuteNonQuery();
                conn.Close();
            }
        }
        ...
        /// <returns></returns>
        private List<book> MapBookDataToList(DataTable bookData)
        {
        ...
        /// <returns></returns>
        private List<bookLendRecord> MapBookLendRecordToList(DataTable bookLendData)
        {
        ...
        private book MapBookDataByIdToList(DataTable bookData)
        {
